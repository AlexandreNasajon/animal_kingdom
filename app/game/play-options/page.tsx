  ...
  return (
    <div className="bioquest-bg">
      ...
      <div className="mb-6 sm:mb-8 text-center relative z-10">
        <h1 className="embossed-title text-3xl sm:text-5xl mb-1 sm:mb-2">BioDuel</h1>
      ...
      <div className="flex flex-col items-center gap-4 sm:gap-6 w-full max-w-md mx-auto px-2 sm:px-4 relative z-10">
        <button
          onClick={() => handlePlayMode("host")}
          className="menu-button primary-button w-full flex items-center justify-center gap-2 sm:gap-3"
        >
